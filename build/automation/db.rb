module Automation
  class DB < Thor
    ...
    def create_schema
      ...
      # sh "build/tools/sql_metal/SqlMetal.exe /server:#{settings.server_name} /database:#{settings.initial_catalog} /code:[Replace with path to code file] /namespace:[Replace with namespace for code file]"
    end
